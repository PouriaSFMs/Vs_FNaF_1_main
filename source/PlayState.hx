...
class PlayState extends MusicBeatState
{
	...
	public static var defaultCamX:Float = 0;
	public static var defaultCamY:Float = 0;
	...
	{
		//trace('Car drive');
		FlxG.sound.play(Paths.soundRandom('carPass', 0, 1), 1.5);
