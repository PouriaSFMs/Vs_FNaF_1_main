...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["Freaky on Five Nights",	"Play the funkin' mod.",						'friday_night_play',	 true],
		["Freddy fazbear more like freddy fartbear",		"Beat Freddy on Hard with no Misses.",				'week1_nomiss',			false],
		["Bad rabbit",				"Beat Bonnie on Hard with no Misses.",				'week2_nomiss',			false],
		["wait how tf did you get this ?",			"Beat Chica on Hard with no Misses.",				'week3_nomiss',			false],
		["are you cheating or something ?",					"Beat Foxy on Hard with no Misses.",				'week4_nomiss',			false]
	];
